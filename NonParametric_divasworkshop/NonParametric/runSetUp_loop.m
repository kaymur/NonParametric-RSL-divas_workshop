...
clearvars -except distFile filelist run_type Seed df pc pctext pd distKern0 distKernel distKernFlor jjj all run_start run_end counter CEFILES IFILES synthflag truth_flag Seed dateField rng datGIA sfile distNorm distKern df
...
%    spatial = 0; modno = 3; synthflag = 2; nsamps = 500000; nburn = 100; thetachange = 15;
    ...
    spatial = 0; modno = 3; synthflag = 0; nsamps = 20000; nburn = 10; thetachange = 15;
    stepchange = 12;  nthin = 10; sampnorm = 0;
end
...
cd(pd);
if synthflag == 1 % sensitivity test
    dateField = [df  '_Sens' num2str(truth_flag)];
    distFile = 'Subregion7_WA_RSL.csv';
elseif synthflag == 2 % validation test
    distFile = 'Subregion7_WA_RSL.csv';
    dateField = [df '_Val'];
else % real data
    dateField = df;
